<?php
/* Smarty version 3.1.31, created on 2019-12-19 03:20:57
  from "C:\wamp64\www\e-SMS\esms-peneraju\administrator\formtools\themes\default\admin\forms\edit\tab_edit_view__filters.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5dfaec9905c537_81290727',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0d733cc6fad5e784c03d6419a808ac36bf68ef92' => 
    array (
      0 => 'C:\\wamp64\\www\\e-SMS\\esms-peneraju\\administrator\\formtools\\themes\\default\\admin\\forms\\edit\\tab_edit_view__filters.tpl',
      1 => 1573338106,
      2 => 'file',
    ),
  ),
...
function content_5dfaec9905c537_81290727 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_function_template_hook')) require_once 'C:\\wamp64\\www\\e-SMS\\esms-peneraju\\administrator\\formtools\\global\\smarty_plugins\\function.template_hook.php';
?>
...
_operators_dates_div"
                             <?php if (!$_smarty_tpl->tpl_vars['selected_field_is_date_field']->value) {?>style="display:none"<?php }?>>
                            <select name="standard_filter_<?php echo $_smarty_tpl->tpl_vars['count']->value;?>
_operator_date">
                                <option value="before"
                                        <?php if ($_smarty_tpl->tpl_vars['operator']->value == "before") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['word_before'];?>
</option>
...
_operator">
                                <option value="equals"
                                        <?php if ($_smarty_tpl->tpl_vars['operator']->value == "equals") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['word_equals'];?>
</option>
                                <option value="not_equals"
                                        <?php if ($_smarty_tpl->tpl_vars['operator']->value == "not_equals") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['phrase_not_equal'];?>
</option>
                                ...
                                <option value="not_like"
                                        <?php if ($_smarty_tpl->tpl_vars['operator']->value == "not_like") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['phrase_not_like'];?>
</option>
                            </select>
                        </div>
                    </td>
                    <td>
                        <div id="standard_filter_<?php echo $_smarty_tpl->tpl_vars['count']->value;?>
_values_dates_div"
                             <?php if (!$_smarty_tpl->tpl_vars['selected_field_is_date_field']->value) {?>style="display:none"<?php }?> class="cf_date_group">
                            <input type="text" name="standard_filter_<?php echo $_smarty_tpl->tpl_vars['count']->value;?>
_filter_date_values"
                                   id="standard_date_<?php echo $_smarty_tpl->tpl_vars['count']->value;?>
...
_values_div"
                             <?php if ($_smarty_tpl->tpl_vars['selected_field_is_date_field']->value) {?>style="display:none"<?php }?>>
                            <input type="text" name="standard_filter_<?php echo $_smarty_tpl->tpl_vars['count']->value;?>
_filter_values" style="width: 144px;"
                                   value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter_values']->value, ENT_QUOTES, 'UTF-8', true);?>
"/>
                        </div>
                    </td>
...
">
                                <option value="account_id"
                                        <?php if ($_smarty_tpl->tpl_vars['filter_values']->value == "account_id") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['word_id'];?>
</option>
                                <option value="first_name"
                                        <?php if ($_smarty_tpl->tpl_vars['filter_values']->value == "first_name") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['phrase_first_name'];?>
</option>
                                <option value="last_name"
                                        <?php if ($_smarty_tpl->tpl_vars['filter_values']->value == "last_name") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['phrase_last_name'];?>
</option>
                                <option value="email"
                                        <?php if ($_smarty_tpl->tpl_vars['filter_values']->value == "email") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['word_email'];?>
</option>
                                <option value="settings__company_name"
                                        <?php if ($_smarty_tpl->tpl_vars['filter_values']->value == "settings__company_name") {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['LANG']->value['phrase_company_name'];?>
</option>
                            </optgroup>
