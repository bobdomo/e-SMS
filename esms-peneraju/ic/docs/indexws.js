const MODEL_PATH = './ic/docs/tfjs_model2/model.json';
...
async function showResult(logits) {
    const message = {
        0: 'Image uploaded is invalid. Please reupload your ic.',
        1: 'IC is validated. Please proceed to the next step.',
        2: 'Image uploaded is invalid. Please reupload your ic.'
    }
